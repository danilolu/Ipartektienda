...
public class CatalogoAppDAOMySQL implements CatalogoAppDAO {
	...
	public CatalogoAppDAOMySQL(String url, String mysqlUser, String mysqlPass) {
		this();
		this.url = url;
	...
	public void iniciarTransaccion() {
		try {
			...
			throw new DAOException("Error al desactivar el autocommit", e);
		}
	}
